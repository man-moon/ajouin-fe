<script>
    ...
    const nav = [
        { title: "학교 소식", path: "/notice", icon: "send" },
...
>
    {#each nav as item}
        {#if currentPath === item.path}
            <div
                class="text-blue-500 font-semibold cursor-default relative flex flex-col items-center justify-center text-center py-2 w-16"
            >
